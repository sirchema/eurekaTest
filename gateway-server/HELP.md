...
* The original package name 'com.formacion.springboot.app.gateway.gateway-server' is invalid and this project uses 'com.formacion.springboot.app.gateway.gatewayserver' instead.
